...
public class ShortLinkController {
    ...
    public BaseResponse<String> visit(@PathVariable("shortLink") String shortLink, HttpServletResponse response) throws IOException {

        String longLink = shortLinkService.getLongLinkByShortLink(shortLink);

        response.sendRedirect(longLink);

        return ResultUtils.success(longLink);
    }
